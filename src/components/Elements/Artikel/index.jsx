...
>
        ...
        <div className="grid grid-cols-12 sm:px-5 gap-x-8 gap-y-16">
          <div className="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
            ...
            Cabai Merupakan tanaman hortikultura sayur sayuran buah semusim untuk rempah rempah yang diperlukan oleh masyarakat
            </p>
          ...
          <div className="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
            ...
            <a className="text-lg font-bold sm:text-xl md:text-2xl">
            Langkah menarik menanam tomat hidroponik
            </a>
            <p className="text-sm text-black">
            tomat merupakan sayur buah yang dapat dibudidayakan secara hidroponik
            </p>
            <div className="pt-2 pr-0 pb-0 pl-0">
