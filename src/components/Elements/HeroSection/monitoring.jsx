    ...
    return (
      <div className=" bg-gray-50 flex items-center">
        <section
          ...
          style={{
            backgroundImage:
              "url('https://www.vaniperen.com/wp-content/uploads/2021/12/Plants-for-Plants-header-young-plant-fruit-growing.jpg')",
          }}
        >
          <div className="container mx-auto text-center text-white">
            <h1 className="text-5xl font-medium mb-6">Monitoring</h1>
